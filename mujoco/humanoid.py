...
if __name__ == "__main__":
    ...
    parser.add_argument("-env", type=str, default="Humanoid-v2", help="Name of the Environment, default = BreakoutNoFrameskip-v4")
    ...
    parser.add_argument("-info", type=str, default="humanoid", help="Name of the training run")
